...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    BOOL showSection = [[self.dataSource objectAtIndex:section] count] != 0 ? (section != 0 ? YES : NO) : YES;
    ...
    headerLabel.text = (showSection) ? [_sectionIndexTitles objectAtIndex:section] : nil;
